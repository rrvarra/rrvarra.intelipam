...
class IntelIPAM:
    ...
    _IPAM_AF_RANGE_JSON_DIR = 'https://af01p-sc.devtools.intel.com/artifactory/it-btrm-local/intel-ipam'
    ...
    def write_json_gz(self, dest_dir=None, keep=3):
        ...
        '''
        if dest_dir is None:
            dest_dir = self._IPAM_AF_RANGE_JSON_DIR
